    ...
    <footer className="bg-white py-10">
      <div className="max-w-[1600px] mx-auto  flex-col lg:flex-row flex gap-10  xl:gap-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[350px] ">
          <div>
            <Image src="/logo.svg" alt="logoImage" width={349} height={28} />
          </div>
          ...
          <div className="mt-6">
            <input
              ...
              className="w-full border rounded px-4 text-center py-2 text-sm border-[#A0A7AD] text-gray-600 mb-4"
            />
      ...
      <div className="flex flex-col justify-center items-center   gap-4  ">
        ...
        <div>
          <h3 className="font-normal text-[15px] leading-[24px] ">
            © IMPAKTER, LLC, 2024. All rights reserved.
          </h3>
        </div>
      </div>
    </footer>
